---
applyTo: "**"
description: "Use when user says 'Start work on git issue #<number>' in chat. Routes to the issue-workflow orchestrator agent."
---
...
3. Invoke the `#issue-workflow` orchestrator agent, passing the issue number.
